...
public class Settings : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (JSONSerialization.IsFileExist(SaveDataUtilities.SettingsPath))
        {
            JSONSerialization.Deserialize(SaveDataUtilities.SettingsPath, data);
    ...
    {
        JSONSerialization.Serialize(SaveDataUtilities.SettingsPath,data, false);
    }
